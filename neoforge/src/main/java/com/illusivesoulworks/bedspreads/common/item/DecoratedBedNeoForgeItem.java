...
import com.illusivesoulworks.bedspreads.client.DecoratedBedNeoForgeItemStackRenderer;
...
public class DecoratedBedNeoForgeItem extends DecoratedBedItem {
  ...
  public void initializeClient(@Nonnull Consumer<IClientItemExtensions> consumer) {
    consumer.accept(new IClientItemExtensions() {
      ...
      public BlockEntityWithoutLevelRenderer getCustomRenderer() {
        ...
        return new DecoratedBedNeoForgeItemStackRenderer(mc.getBlockEntityRenderDispatcher(),
                                                         mc.getEntityModels());
      }
    });
  }
