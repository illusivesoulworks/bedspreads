...
public class DecoratedBedNeoForgeItemStackRenderer extends BlockEntityWithoutLevelRenderer {

  public DecoratedBedNeoForgeItemStackRenderer(BlockEntityRenderDispatcher blockEntityRenderDispatcher,
