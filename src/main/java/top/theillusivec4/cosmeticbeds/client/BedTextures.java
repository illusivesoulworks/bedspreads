...
public class BedTextures {
    ...
    public static final Cache BED_DESIGNS = new Cache("cosmetic_bed_", new ResourceLocation(CosmeticBeds.MODID,
        ...
        public ResourceLocation getResourceLocation(String id, List<BannerPattern> patternList, List<EnumDyeColor> colorList) {
            ...
            if (id.isEmpty()) {
                ...
                if (bedtextures$cacheentry == null) {
                    ...
                    Minecraft.getInstance().getTextureManager().loadTexture(bedtextures$cacheentry.textureLocation,
        ...
        private boolean freeCacheSlot() {
            ...
            while (iterator.hasNext()) {
                ...
                if (i - bedtextures$cacheentry.lastUseMillis > 5000L) {
                    Minecraft.getInstance().getTextureManager().deleteTexture(bedtextures$cacheentry.textureLocation);
                    iterator.remove();
                    return true;
                }
            }
